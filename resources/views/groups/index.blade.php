<x-app-layout>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mb-8">
        <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl shadow-sm p-6 border-l-4 border-blue-500 hover:shadow-lg transition-shadow duration-300">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-blue-700 font-medium">Desarrollo Software</p>
                    <p class="text-2xl font-bold text-blue-900 mt-1">2 Grupos</p>
                </div>
        ...
        <div class="bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl shadow-sm p-6 border-l-4 border-[#FF9C00] hover:shadow-lg transition-shadow duration-300">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-orange-700 font-medium">Marketing Digital</p>
                    <p class="text-2xl font-bold text-orange-900 mt-1">1 Grupo</p>
                </div>
                <div class="bg-orange-200 p-3 rounded-lg">
                    <i class="fas fa-bullhorn text-[#FF9C00] text-2xl"></i>
                </div>
            </div>
        </div>

        <div class="bg-gradient-to-br from-green-50 to-green-100 rounded-xl shadow-sm p-6 border-l-4 border-green-500 hover:shadow-lg transition-shadow duration-300">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-green-700 font-medium">Soporte</p>
                    <p class="text-2xl font-bold text-green-900 mt-1">0 Grupos</p>
                </div>
                <div class="bg-green-200 p-3 rounded-lg">
                    <i class="fas fa-headset text-green-700 text-2xl"></i>
                </div>
            </div>
        </div>
    </div>
